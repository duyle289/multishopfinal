...
namespace WebBanlaptop.Models
{
    ...
    public partial class SANPHAM
    {
        ...
        public bool tinhTrangSanPham; // h?t hàng ho?c còn hàng => s? l??ng t?n = 0
        public List<NHASANXUAT> listNSX;
        public List<LOAISANPHAM> listloaiSP;
        public string urlBack; // khi nh?n vào button tr? l?i ? productDetail thì s? tr? l?i link d?a vào bi?n urlBack
        public string searchingValue; // l?u giá tr? mà ng??i dùng nh?p vào ô tìm ki?m s?n ph?m (action: SearchProduct)
    }
}
